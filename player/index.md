...
plcustom = fs_Playerjs({ OSD:false, id:"mpl", nocontrols:1, autoplay:1, loop:0, title:arrayInterno[j].title, file:[ {title:"",file:arrayInterno[j].file} ] });
