...
mainVideo.innerHTML='<div style="overflow:auto; width:100%;height:100%;color:#fff;background:#000;"><br/><img style="display:block;  pointer-events:none;  width:48px;  text-align:center;margin:0 auto;" src="https://player.fcasfs-of.cloud-fs.net/icons/fl_lock.png"/><br/>It is not possible to access the File because it is Private.<br/><br/><br/><br/></div>';
