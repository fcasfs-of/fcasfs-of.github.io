function onstart_file(run_file){    
  ...
  if(typeof run_file=='function'){  
    ...
    if(run_file().pg_dark==true){  
      sryrkk="<style> body, body img, .markdown-body div { color:#fff; background:#111; }  .markdown-body h2 img, .markdown-body h2{   color:#fff;  background:#111;  background-color:#111;   } body img{ pointer-events:none; }  </style>";  
    }  
