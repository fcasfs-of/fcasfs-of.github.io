...
if(state){  if(state.libras===true){   
    ...
    function injectStyles() {
        const css = `
            ...
            body.fs-acc-cursor a:hover, body.fs-acc-cursor button:hover {   cursor: url('data:image/svg+xml;base64,'), auto !important;   }
        `;
        const style = document.createElement('style');
