const fs_accessibility = (function() {
    ...
    const icons = {
        ...
        textPlus: `<svg viewBox="0 0 24 24"><path d="M5 13h3v3h2v-3h3v-2h-3V8H8v3H5v2zm13-5l-4 4h3v4h2v-4h3l-4-4z"/></svg>`,
    ...
    function render() {
        ...
        modal.innerHTML = `
            ...
            <div class="fs-acc-grid">
                <div class="fs-acc-item" onclick="fs_accessibility.update('zoom', 10)">${icons.textPlus} ${lang.increaseText}</div>
                <div class="fs-acc-item" onclick="fs_accessibility.update('zoom', -10)">${icons.textPlus} ${lang.decreaseText}</div>
                <div class="fs-acc-item" data-key="fontReadable" onclick="fs_accessibility.update('fontReadable')">${icons.animation} ${lang.readableFont}</div>
