...
@media (max-height: 480px) and (orientation: landscape) {
 ...
 function applyConfigClasses() {
  ...
  function renderToolbar() {
    ...
    const tools = [
      { id: "select", label: "Tudo", svg: svgs.selectAll, action: doSelectAll },
      { id: "del", label: "Excluir", svg: svgs.delete, action: doDeleteSelection },
      { id: "clear", label: "Limpar", svg: svgs.clear, action: doClearAll },
      { id: "copy", label: "Copiar", svg: svgs.copy, action: doCopy },
      { id: "paste", label: "Colar", svg: svgs.paste, action: doPaste }
    ];
    ...
    themeBtn.innerHTML = `${svgs.theme} <span>${isDarkTheme ? "Escuro" : "Claro"}</span>`;
    ...
    let posLabel = "Fixo";
    if (vkPosition === "left") posLabel = "Esq";
    if (vkPosition === "right") posLabel = "Dir";
  ...
  function init(buttonContainerId = null) {
      injectStyles();
