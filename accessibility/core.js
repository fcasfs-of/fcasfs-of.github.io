...
const fs_accessibility = (function() {
    ...
    const icons = {
		...
		lupa: `<svg xmlns="http://w3.org" width="24px" height="24px" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">          <circle cx="11" cy="11" r="8"></circle>       <line x1="21" y1="21" x2="16.65" y2="16.65"></line>       <line x1="11" y1="8" x2="11" y2="14"></line>     </svg>`,
...
@keyframes zoomIn { from { transform: scale(0.8); opacity: 0; } to { transform: scale(1); opacity: 1; } }
    ...
    function applyAll() {
        ...
        // Ativar/Desativar
		if (state.lupa) {  controlarZoomSite(true);   }
