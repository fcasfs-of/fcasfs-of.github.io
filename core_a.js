...
en:[
     ...
     { label: 'Chat', desc: 'Chat area: an interactive space to chat, ask questions, and share information in real time.  ', icon: '<svg width="24px" height="24px" viewBox="0 0 17 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>', onClick: function(){   if(document.querySelector(".fs-acc-btnch")){  document.querySelector(".fs-acc-btnch").click();  }  } },
     { label: 'Accessibility', desc: 'Accessibility Area: Resources and options to ensure easy and inclusive use of our website by all users.  ', icon: '<svg width="24px" height="24px" viewBox="0 0 17 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M12 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm9 7h-6v13h-2v-6h-2v6H9V9H3V7h18v2z"/></svg>', onClick: function(){   if(document.querySelector(".fs-acc-btn")){  document.querySelector(".fs-acc-btn").click();  }  } },
...
pt:[
     ...
     { label: 'Chat', desc: 'Área do chat: um espaço interativo para conversar, tirar dúvidas e compartilhar informações em tempo real.  ', icon: '<svg width="24px" height="24px" viewBox="0 0 17 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>', onClick: function(){   if(document.querySelector(".fs-acc-btnch")){  document.querySelector(".fs-acc-btnch").click();  }  } },
     { label: 'Acessibilidade', desc: 'Área de Acessibilidade: Recursos e opções para garantir uso fácil e inclusivo do nosso site por todos os usuários.  ', icon: '<svg width="24px" height="24px" viewBox="0 0 17 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M12 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm9 7h-6v13h-2v-6h-2v6H9V9H3V7h18v2z"/></svg>', onClick: function(){   if(document.querySelector(".fs-acc-btn")){  document.querySelector(".fs-acc-btn").click();  }  } },
