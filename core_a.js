...
{ separate:true, disable:false, status:{type:"desenvolvimento"}, tip:{pos:"top",visible:false,text:"In Development"}, info:{pos:"right",text:"Windows",color:"disabled", type:"d"}, remove_efect:true, icon:'<img src="/Icon/i-app.png"/>',title:'Search Files in Folders   <span id="versionlfoldfdf"></span>',desc:"The app allows selecting a folder, choosing the file format, entering text, and searching files in the folder. ", links:[{type:"a",link:"/Search-Files-in-Folders/",disable:true,text:"Access Website", icon:'site'},{type:"button",id:"prev1",text:"Screenshot", icon:'preview'} ]},
],
pt:[
