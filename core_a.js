...
sidebar:{
en:[
     { label: 'Docs', desc: 'A modern, responsive, and standalone document manager and viewer.  ', icon: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/></svg>', onClick: function(){  location.href="/docs/en"; } },
     { separate:true }, 
...
pt:[
     { label: 'Docs', desc: 'Um gerenciador e visualizador de documentos moderno, responsivo e autônomo.  ', icon: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/></svg>', onClick: function(){  location.href="/docs"; } },
     { separate:true }, 
...
{ separate:true, info:{pos:"right",text:"Web"}, icon:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" style="color: var(--accent); filter: drop-shadow(0 0 8px rgba(59, 130, 246, 0.4));">      <path d="M17 10.5V7c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-3.5l4 4v-11l-4 4zM12 14L9.75 11l-1.5 2L7 10l-3 4h14l-3-4-3 4z"/>         </svg>',title:"MP4 Quality Analyzer",desc:'Professional MP4 quality analyzer for technical diagnostics. <br/> Performs full video and audio analysis, with options to save thumbnails and diagnostic reports.', links:[{type:"a",link:"/mp4_qa/",text:"Visit the Page"} ]},
...
{ separate:true, info:{pos:"right",text:"Web"}, icon:'<svg viewBox="0 0 24 24" width="26" height="26" fill="none" style="color: var(--accent); filter: drop-shadow(0 0 8px rgba(59, 130, 246, 0.4));">      <path d="M17 10.5V7c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-3.5l4 4v-11l-4 4zM12 14L9.75 11l-1.5 2L7 10l-3 4h14l-3-4-3 4z"/>         </svg>',title:"Analisador de Qualidade MP4",desc:'Analisador profissional de qualidade técnica para arquivos MP4. <br/> Realiza diagnóstico completo de vídeo e áudio, com opções para salvar miniatura e relatório detalhado.', links:[{type:"a",link:"/mp4_qa/",text:"Visite a Página"} ]},
