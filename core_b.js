...
function fs_pagination(config) {
  ...
  function atualizar() {  
    ...
    btnAnterior.onclick = () => { paginaAtual--; atualizar();     if(listaContainer){   listaContainer.scrollIntoView({ behavior: 'smooth', block: "start" });    }   };
    ...
    for (let i = 1; i <= totalPaginas; i++) {
      ...
      btnNum.innerText = i;
      btnNum.onclick = () => { paginaAtual = i; atualizar();    if(listaContainer){   listaContainer.scrollIntoView({ behavior: 'smooth', block: "start" });    }  };
    ...
    btnProximo.onclick = () => { paginaAtual++; atualizar();     if(listaContainer){   listaContainer.scrollIntoView({ behavior: 'smooth', block: "start" });    }   };
