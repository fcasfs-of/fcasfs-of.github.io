...
function gerenciarAreaFav_start(idioma){  document.body.onload=function(){    gerenciarAreaFav(idioma);  };   }
...
function astorage_ps_crtew(cokk_plu_esdnf) {   document.body.onload=function(){    storage_ps_crtew(cokk_plu_esdnf);  };     }
