...
return "";   }
    ...
    function renderizarCatalogo(a,b,c,d="pt"){const e=document.getElementById(b);if(!e)return;let f=document.getElementById(a);if(!f){f=document.createElement("div"),f.id=a,e.parentNode.insertBefore(f,e)}if(!document.getElementById("catalog-filter-styles")){const g=document.createElement("style");g.id="catalog-filter-styles",g.textContent=`.catalog-controls-container{display:flex!important;flex-direction:column!important;gap:1rem!important;margin-bottom:2rem!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;overflow:auto!important;font-family:system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif!important}@media(min-width:769px){.catalog-controls-container{flex-direction:row!important;align-items:center!important;justify-content:space-between!important;background:#fff!important;padding:.75rem 1.25rem!important;border-radius:12px!important;border:1px solid #e5e7eb!important}}.catalog-filter-nav-wrapper{position:relative!important;width:100%!important;max-width:100%!important;overflow:hidden!important;box-sizing:border-box!important}@media(min-width:769px){.catalog-filter-nav-wrapper{width:auto!important;flex:1!important}}.catalog-filter-nav{display:flex!important;gap:.5rem!important;width:100%!important;max-width:100%!important;overflow-x:auto!important;overflow-y:hidden!important;white-space:nowrap!important;box-sizing:border-box!important;scrollbar-width:auto!important;-webkit-overflow-scrolling:touch!important;padding:.25rem .1rem .5rem .1rem!important}.catalog-filter-btn{display:inline-block!important;background:#f3f4f6!important;border:1px solid #e5e7eb!important;padding:.6rem 1.25rem!important;border-radius:8px!important;cursor:pointer!important;font-weight:600!important;color:#4b5563!important;transition:all .2s cubic-bezier(.4,0,.2,1)!important;white-space:nowrap!important;font-size:.875rem!important;flex-shrink:0!important;min-height:44px!important}.catalog-filter-btn.active{background:#1d4ed8!important;color:#fff!important;border-color:#1d4ed8!important}.catalog-filter-btn:hover:not(.active){background:#e5e7eb!important;color:#111827!important}.catalog-toggle-wrapper{display:flex!important;align-items:center!important;justify-content:space-between!important;gap:.75rem!important;cursor:pointer!important;user-select:none!important;font-size:.875rem!important;font-weight:600!important;color:#374151!important;white-space:nowrap!important;padding:.75rem 1rem!important;flex-shrink:0!important;background:#fff!important;border:1px solid #e5e7eb!important;border-radius:8px!important;min-height:44px!important;box-sizing:border-box!important}@media(min-width:769px){.catalog-toggle-wrapper{border:none!important;padding:0!important;background:transparent!important;justify-content:flex-end!important}}.catalog-toggle-wrapper input{opacity:0!important;width:0!important;height:0!important;position:absolute!important}.catalog-switch{position:relative!important;display:inline-block!important;width:40px!important;height:22px!important;background-color:#e5e7eb!important;border-radius:22px!important;transition:background-color .2s ease!important;flex-shrink:0!important}.catalog-switch::after{content:""!important;position:absolute!important;width:16px!important;height:16px!important;border-radius:50%!important;background-color:#fff!important;top:3px!important;left:3px!important;transition:transform .2s cubic-bezier(.4,0,.2,1)!important;box-shadow:0 1px 3px rgba(0,0,0,.15)!important}.catalog-toggle-wrapper input:checked+.catalog-switch{background-color:#1d4ed8!important}.catalog-toggle-wrapper input:checked+.catalog-switch::after{transform:translateX(18px)!important}`+c+`{transition:opacity .25s cubic-bezier(.4,0,.2,1),transform .25s cubic-bezier(.4,0,.2,1)!important;will-change:opacity,transform!important}`,document.head.appendChild(g)}const h=e.querySelectorAll(c);if(0===h.length)return;const i=new Set,j={pt:{todos:"Todos",novo:"Novo",apenasNovos:"Apenas novidades"},en:{todos:"All",novo:"New",apenasNovos:"Only new items"}},k=j[d]?d:"pt";h.forEach(a=>{const b=a.querySelector(".ribbond");if(b){const c=b.textContent.trim();i.add(c),a.dataset.category=c}else a.dataset.category="";const e=a.querySelector(".badge");e?(e.textContent=j[k].novo,a.dataset.isNew="true"):a.dataset.isNew="false"});const l=Array.from(i);f.innerHTML="";const m=document.createElement("div");m.className="catalog-controls-container";const n=document.createElement("div");n.className="catalog-filter-nav-wrapper";const o=document.createElement("div");o.className="catalog-filter-nav";const p=document.createElement("button");p.className="catalog-filter-btn active",p.textContent=j[k].todos,p.onclick=()=>t(p,"all",q.checked),o.appendChild(p),l.forEach(a=>{const b=document.createElement("button");b.className="catalog-filter-btn",b.textContent=a,b.onclick=()=>t(b,a,q.checked),o.appendChild(b)}),n.appendChild(o),m.appendChild(n);const r=document.createElement("label");r.className="catalog-toggle-wrapper";const q=document.createElement("input");q.type="checkbox",q.onchange=()=>{const a=o.querySelector(".catalog-filter-btn.active"),b=a===p?"all":a.textContent;t(a,b,q.checked)};const s=document.createElement("span");s.className="catalog-switch";const u=document.createElement("span");u.textContent=j[k].apenasNovos,r.appendChild(q),r.appendChild(s),r.appendChild(u),m.appendChild(r),f.appendChild(m);function t(a,b,c){o.querySelectorAll(".catalog-filter-btn").forEach(a=>a.classList.remove('active')),a.classList.add('active'),h.forEach(a=>{const d="all"===b||a.dataset.category===b,e=!c||"true"===a.dataset.isNew;if(a.dataset.timeoutId&&clearTimeout(Number(a.dataset.timeoutId)),d&&e){a.style.display="",requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="translateY(0)"})}else{a.style.opacity="0",a.style.transform="translateY(8px)";const b=setTimeout(()=>{a.style.display="none"},250);a.dataset.timeoutId=String(b)}})}}
