...
fsmodal_open({
  ...
  include:{    player:"no"  },
  content:{
    title:"",    type:"", context:"<div class='scards-container dark-mode' style='overflow: hidden;  padding: 10px;  '><div class='card' style='width: 100%; position: absolute; height: 100%; top: 0; left: 0; overflow: auto; right: 0; bottom: 0;'>"+spsdrojeufgg+"</div></div>  <style>.modal-content .card .card-links button.page-link { display:none;  }  .modal-content .card .card-icon svg { fill: currentColor;  }    .modal-content .card .ribbond {   text-align: center;   text-transform: uppercase;  position: absolute;   top: 0;    right: 0;    left: 0;}  } </style>",    size:"500",    description:""
  }
});
		   }
	  }
