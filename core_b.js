...
function fs_pagination(config) {
  ...
  function atualizar() {  
    ...
    btnAnterior.onclick = () => { paginaAtual--; atualizar();     if(listaContainer){   listaContainer.scroll({  top: 0,  behavior: 'smooth' });    }   };
    ...
    for (let i = 1; i <= totalPaginas; i++) {
      ...
      btnNum.innerText = i;
      btnNum.onclick = () => { paginaAtual = i; atualizar();    if(listaContainer){   listaContainer.scroll({  top: 0,  behavior: 'smooth' });    }  };
    ...
    btnProximo.onclick = () => { paginaAtual++; atualizar();     if(listaContainer){   listaContainer.scroll({  top: 0,  behavior: 'smooth' });    }   };
