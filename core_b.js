...
function fs_pagination(config) {
  ...
  function atualizar() {  
    ...
    btnAnterior.onclick = () => { paginaAtual--;  listaContainer.scrollTo({ top: 0, behavior: 'smooth' });  atualizar();  };
    ...
    for (let i = 1; i <= totalPaginas; i++) {
      ...
      btnNum.innerText = i;
      btnNum.onclick = () => { paginaAtual = i;  listaContainer.scrollTo({ top: 0, behavior: 'smooth' });  atualizar();  };
    ...
    btnProximo.onclick = () => { paginaAtual++;  listaContainer.scrollTo({ top: 0, behavior: 'smooth' });  atualizar();  };
