...
fsmodal_open({
  ...
  include:{    player:"no"  },
  content:{
    title:"",    type:"", context:"<div class='scards-container dark-mode' style='overflow: hidden;  padding: 10px;  '><div class='card'>"+spsdrojeufgg+"</div></div>  <style>. modal-content .card-links button { display:none;  } </style>",    size:"500",    description:""
  }
});
		   }
	  }
